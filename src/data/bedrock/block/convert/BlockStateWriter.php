...
final class BlockStateWriter{
	...
	/** @return $this */
	public function writeFacingDirection(Facing $value) : self{
	...
	/** @return $this */
	public function writeBlockFace(Facing $value) : self{
	...
	/** @return $this */
	public function writeEndRodFacingDirection(Facing $value) : self{
		//end rods are stupid in bedrock and have everything except up/down the wrong way round
		return $this->writeFacingDirection($value->axis() !== Axis::Y ? $value->opposite() : $value);
	}

	/** @return $this */
	public function writeHorizontalFacing(Facing $value) : self{
	...
	/** @return $this */
	public function writeWeirdoHorizontalFacing(Facing $value) : self{
		$this->writeInt(BlockStateNames::WEIRDO_DIRECTION, match ($value) {
			Facing::EAST => 0,
			Facing::WEST => 1,
			Facing::SOUTH => 2,
			Facing::NORTH => 3,
			default => throw new BlockStateSerializeException("Invalid horizontal facing " . $value->name)
		});
		return $this;
	}

	/** @return $this */
	public function writeLegacyHorizontalFacing(Facing $value) : self{
	 ...
	 * @return $this
	 */
	public function write5MinusHorizontalFacing(Facing $value) : self{
	 ...
	 * @return $this
	 */
	public function writeCardinalHorizontalFacing(Facing $value) : self{
	...
	/** @return $this */
	public function writeCoralFacing(Facing $value) : self{
	...
	/** @return $this */
	public function writeFacingWithoutDown(Facing $value) : self{
	...
	/** @return $this */
	public function writeFacingWithoutUp(Facing $value) : self{
		if($value === Facing::UP){
	...
	/** @return $this */
	public function writePillarAxis(Axis $axis) : self{
	...
	/** @return $this */
	public function writeTorchFacing(Facing $facing) : self{
		...
		$this->writeString(BlockStateNames::TORCH_FACING_DIRECTION, match ($facing) {
			...
			default => throw new BlockStateSerializeException("Invalid Torch facing " . $facing->name)
		});
		return $this;
	}
