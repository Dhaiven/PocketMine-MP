...
final class VanillaItems{
	...
	protected static function setup() : void{
		...
		self::register("record_11", (new Record(new IID(Ids::RECORD_11), "Record 11"))->setRecordType(RecordType::DISK_11()));
		self::register("record_13", (new Record(new IID(Ids::RECORD_13), "Record 13"))->setRecordType(RecordType::DISK_13()));
		self::register("record_5", (new Record(new IID(Ids::RECORD_5), "Record 5"))->setRecordType(RecordType::DISK_5()));
		self::register("record_blocks", (new Record(new IID(Ids::RECORD_BLOCKS), "Record Blocks"))->setRecordType(RecordType::DISK_BLOCKS()));
		self::register("record_cat", (new Record(new IID(Ids::RECORD_CAT), "Record Cat"))->setRecordType(RecordType::DISK_CAT()));
		self::register("record_chirp", (new Record(new IID(Ids::RECORD_CHIRP), "Record Chirp"))->setRecordType(RecordType::DISK_CHIRP()));
		self::register("record_far", (new Record(new IID(Ids::RECORD_FAR), "Record Far"))->setRecordType(RecordType::DISK_FAR()));
		self::register("record_mall", (new Record(new IID(Ids::RECORD_MALL), "Record Mall"))->setRecordType(RecordType::DISK_MALL()));
		self::register("record_mellohi", (new Record(new IID(Ids::RECORD_MELLOHI), "Record Mellohi"))->setRecordType(RecordType::DISK_MELLOHI()));
		self::register("record_otherside", (new Record(new IID(Ids::RECORD_OTHERSIDE), "Record Otherside"))->setRecordType(RecordType::DISK_OTHERSIDE()));
		self::register("record_pigstep", (new Record(new IID(Ids::RECORD_PIGSTEP),"Record Pigstep"))->setRecordType(RecordType::DISK_PIGSTEP()));
		self::register("record_stal", (new Record(new IID(Ids::RECORD_STAL), "Record Stal"))->setRecordType(RecordType::DISK_STAL()));
		self::register("record_strad", (new Record(new IID(Ids::RECORD_STRAD), "Record Strad"))->setRecordType(RecordType::DISK_STRAD()));
		self::register("record_wait", (new Record(new IID(Ids::RECORD_WAIT), "Record Wait"))->setRecordType(RecordType::DISK_WAIT()));
		self::register("record_ward", (new Record(new IID(Ids::RECORD_WARD), "Record Ward"))->setRecordType(RecordType::DISK_WARD()));
		...
		self::register("spider_eye", new SpiderEye(new IID(Ids::SPIDER_EYE), "Spider E ye"));
